...
<template>
    <div class="datetime-picker" :style="{ width:width }">
        ...
        >
        <span class="picker-ico" @click="clearValue" title="清空">
            <icon :name="value ? 'calendar-times-o':'calendar-o'"></icon>
        </span>
                ...
                <table class="date-picker">
                    ...
                    <tbody>
                        <tr v-for="i in 6">
                            ...
                            >
                                {{ days[(i == 1 ? j-1 : (i-1) * 7 + j-1)].showDay }}
...
export default {
    ...
    methods: {
        ...
        getDays () {
            ...
            let startDays = (()=>{
                ...
                for(let i=length; i>0; i--){
                    tempArr.push({
                        ...
                        showDay:this.formatDate(new Date(this.now.getFullYear(),this.now.getMonth()-1,preMonthLastDay.getDate()-i+1),"dd")
                    })
                }
                return tempArr
            })();
            ...
            let nowDays = (()=>{
                ...
                for(let i=0; i<length; i++){
                    tempArr.push({
                        ...
                        showDay:this.formatDate(new Date(this.now.getFullYear(),this.now.getMonth(),i+1),"dd")
                    })
                }
                return tempArr;
            })();
            ...
            let endDays = (()=>{
                ...
                for(let i=0; i<length; i++){
                    tempArr.push({
                        ...
                        showDay: this.formatDate(new Date(this.now.getFullYear(),this.now.getMonth()+1,i+1),"dd")
                    })
                }
                return tempArr;
            })();
            ...
            [endDays,nowDays,startDays] = [null,null,null];
        },
